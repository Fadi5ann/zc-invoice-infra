...
export const useEnterpriseCreateFormStructure = ({
  ...
  const activityField: Field<SelectFieldProps> = {
    ...
    props: {
      value: store.createDto.activityId ? String(store.createDto.activityId) : '',
      onValueChange: (value) => {
  ...
  const currencyField: Field<SelectFieldProps> = {
    ...
    props: {
      value: store.createDto.currencyId ? String(store.createDto.currencyId) : '',
      onValueChange: (value) => {
  ...
  const paymentConditionField: Field<SelectFieldProps> = {
    ...
    props: {
      value: store.createDto.paymentConditionId ? String(store.createDto.paymentConditionId) : '',
      onValueChange: (value) => {
  ...
  const enterpriseInformation: FormStructure = {
    title: { value: 'Enterprise information' },
    ...
    fieldsets:[
      {
        ...
        rows: [
          { fields: [nameField] },
          { fields: [particularField, ...(store.createDto.particular ? [] :[taxIdNumberField])] },
  ...
  const socialTitleField: Field<SelectFieldProps> = {
    ...
    props: {
      ...
      options: Object.values(SocialTitles).map((title) => ({ label: title, value: title }))
    }
  };
  ...
  const interlocutorInformation: FormStructure = {
    title: { value: 'Interlocutor information' },
    fieldsets: [
      {
        rows: [
...
const deliveryZipCodeField: Field<NumberFieldProps> = {
    ...
    props: {
      value: store.createDto.deliveryAddress.zipcode || undefined,
      onChange: (value) => {
  ...
  const deliveryCountryField: Field<SelectFieldProps> = {
    ...
    props: {
      value: store.createDto.deliveryAddress.countryId ? String(store.createDto.deliveryAddress.countryId) : '',
      onValueChange: (value) => {
  ...
  const invoicingZipCodeField: Field<NumberFieldProps> = {
    ...
    placeholder: tContact('address.form.placeholders.zipCode'),
    props: {
      value: store.createDto.invoicingAddress.zipcode || undefined,
      onChange: (value) => {
  ...
  const invoicingCountryField: Field<SelectFieldProps> = {
    ...
    placeholder: tContact('address.form.placeholders.country'),
    props: {
      value: store.createDto.invoicingAddress.countryId ? String(store.createDto.invoicingAddress.countryId) : '',
      onValueChange: (value) => {
  ...
  const addressInformation: FormStructure = {
    title: { value: tContact('enterprise.form.addressInformation') },
    fieldsets:[
      {
        title: { value: tContact('enterprise.form.deliveryAddress'), className: 'text-sm font-bold' },
        description: { value: tContact('enterprise.form.descriptions.deliveryAddress'), className: 'text-xs' },
        component: (
          <Button variant={'outline'} size="sm" type="button" onClick={() => store.setNested('createDto.deliveryAddress', { ...store.createDto.invoicingAddress })}>
            <Copy />
      ...
      {
        title: { value: tContact('enterprise.form.invoicingAddress'), className: 'text-sm font-bold' },
        description: { value: tContact('enterprise.form.descriptions.invoicingAddress'), className: 'text-xs' },
        component: (
          <Button variant={'outline'} size="sm" type="button" onClick={() => store.setNested('createDto.invoicingAddress', { ...store.createDto.deliveryAddress })}>
            <Copy />
